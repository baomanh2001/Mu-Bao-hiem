...
enum State {ChuaCaiMu, ChuaDoiLen,  CaiMuDoiLen};
State state = ChuaCaiMu;

enum Sleep {Start, Stop};
...
//
//  if(SleepStatus == Start &&  NowSleep - StartSleep >  10000)
//        Going_To_Sleep();
}
